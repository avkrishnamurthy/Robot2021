...
import frc.robot.commands.GalacticSearch.GalacticSearchPathB;
import frc.robot.commands.GalacticSearch.GalacticSearchPathA;
import frc.robot.commands.AutonomousRoutines.MainAuto;
...
import frc.robot.commands.driveTrain.Slalom.AutoSlalom;
...
import frc.robot.commands.driveTrain.Barrel.AutoBarrel;
import frc.robot.commands.driveTrain.Bounce.AutoBounce;
import frc.robot.commands.driveTrain.MainAutoDrive.StartToLowGoal;
import frc.robot.commands.driveTrain.PathA.PathADrive;
...
public class RobotContainer {
  ...
  public RobotContainer() {
      ...
      complexAuto = new MainAuto(driveTrain, scoop);
      galacticSearchPathA = new GalacticSearchPathA(driveTrain, scoop);

...
public class Rotation extends CommandBase {
  ...
  @Override
  public void execute() {
    m_controlPanel.controlPanelRotate(ControlPanelConstants.controlPanelRotationPosition);
  ...
  public boolean isFinished() {
    return m_controlPanel.isColorWheelAtPos(ControlPanelConstants.controlPanelRotationPosition);
  }
}

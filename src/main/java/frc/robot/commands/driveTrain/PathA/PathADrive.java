...
public class PathADrive extends SequentialCommandGroup {
  /** Creates a new RedPathAGalacticSearch. */
  public PathADrive(DriveTrain driveTrain) {
    ...
    new PathAGoStraight(driveTrain).withTimeout(1.4),
    new PathAStop(driveTrain).withTimeout(0.2));
  }
}
